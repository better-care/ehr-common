...
class MultilineStringYamlSerializerTest {
    ...
    fun testSimpleStringFromYamlToYaml() {
        ...
        """.trimIndent()
        val obj: MultiLineObject = yamlObjectMapper.readValue(string, MultiLineObject::class.java)
    ...
    fun testComplexMultiLineStringFromJsonToYaml() {
        ...
        val obj: MultiLineObject = jsonObjectMapper.readValue(string, MultiLineObject::class.java)
        assertThat(obj.description).contains("\t")
        assertThat(obj.description).contains("\r")
    ...
    fun testSingleLineStringFromJsonToYamlTransformsToMultiLineString() {
        ...
        val obj: SingleLineObject = jsonObjectMapper.readValue(string, SingleLineObject::class.java)
