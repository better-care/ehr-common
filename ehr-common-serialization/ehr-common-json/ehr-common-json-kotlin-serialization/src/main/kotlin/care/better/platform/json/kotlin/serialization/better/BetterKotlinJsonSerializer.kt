 ...
 * @since 4.2.2
 *
 * Capable of serializing RM model in a format defined by Better.
 *
 * @constructor Creates a new instance of [BetterKotlinJsonSerializer]
 * @param serializerModules [List] of additional [SerializersModule] to include
 */
class BetterKotlinJsonSerializer(private val serializerModules: List<SerializersModule> = emptyList()) {
